...
public class azureFace {
    ...
    public static void main(String[] args) {
         ...
         * Authenticate
         */
        final String KEY = "507dd5fbd0fb44f5a26f7975912b5e70";
        ...
        final AzureRegions SOUTHCENTRALUS = AzureRegions.SOUTHCENTRALUS;

        // Create Face client
        FaceAPI client = FaceAPIManager.authenticate(SOUTHCENTRALUS, KEY);
        /**
         * END - Authenticate
         */
